...
class BookRepository:
    ...
    def FindBookByIsbn(self, isbn):
        ...
        try:
            # Envoyer une requête et obtenir une réponse JSON
            ...
            image_link = volume_info.get("imageLinks", {}).get("thumbnail", "N/A")
            ...
            access_info = book_data["items"][0].get("accessInfo", {}).get("accessViewStatus", "N/A")
            sale_info = book_data["items"][0].get("saleInfo", {}).get("buyLink", "N/A")
